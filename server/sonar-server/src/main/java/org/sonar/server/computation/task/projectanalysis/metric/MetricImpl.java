...
public final class MetricImpl implements Metric {
  ...
  private final boolean historyStored;

  public MetricImpl(int id, String key, String name, MetricType type, boolean historyStored) {
    this(id, key, name, type, null, null, false, historyStored);
  }

  public MetricImpl(int id, String key, String name, MetricType type, @Nullable Integer decimalScale,
                    @Nullable Double bestValue, boolean bestValueOptimized, boolean historyStored) {
  ...
  public String toString() {
    return toStringHelper(this)
      ...
      .add("historyStored", historyStored)
      .toString();
  }
}
