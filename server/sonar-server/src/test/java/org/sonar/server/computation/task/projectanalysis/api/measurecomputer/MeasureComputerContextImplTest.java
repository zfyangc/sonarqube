...
public class MeasureComputerContextImplTest {
  ...
  public MetricRepositoryRule metricRepository = new MetricRepositoryRule()
    ...
    .add(new MetricImpl(2, INT_METRIC_KEY, "int metric", Metric.MetricType.INT, true))
    .add(new MetricImpl(3, DOUBLE_METRIC_KEY, "double metric", Metric.MetricType.FLOAT, true))
    .add(new MetricImpl(4, LONG_METRIC_KEY, "long metric", Metric.MetricType.MILLISEC, true))
    .add(new MetricImpl(5, STRING_METRIC_KEY, "string metric", Metric.MetricType.STRING, true))
    .add(new MetricImpl(6, BOOLEAN_METRIC_KEY, "boolean metric", Metric.MetricType.BOOL, true));
