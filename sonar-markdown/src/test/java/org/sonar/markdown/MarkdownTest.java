...
public class MarkdownTest {
  ...
  public void shouldEmphasisText() {
    ...
    assertThat(Markdown.convertToHtml("This should not be * \n emphasised")).isEqualTo("This should not be * <br/> emphasised");
    ...
    assertThat(Markdown.convertToHtml("Not * emphasised * because of whitespaces")).isEqualTo("Not * emphasised * because of whitespaces");
    assertThat(Markdown.convertToHtml("Not *emphasised * because of whitespace")).isEqualTo("Not *emphasised * because of whitespace");
    assertThat(Markdown.convertToHtml("Not * emphasised* because of whitespace")).isEqualTo("Not * emphasised* because of whitespace");
    assertThat(Markdown.convertToHtml("emphasised*inside*word")).isEqualTo("emphasised<strong>inside</strong>word");
    assertThat(Markdown.convertToHtml("*Emphasise many words*")).isEqualTo("<strong>Emphasise many words</strong>");
  }
